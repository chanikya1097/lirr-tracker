...
|           |   (Triggers Python Scripts & dbt runs on a schedule)              |            |
|           +-------------------------------------------------------------------+            |
|                                 |                       |                                  |
|                                 v                       v                                  |
|  +-------------------------+     +----------------+     +-----------------------+           |
|  | Python Ingestion Script | --> | Kafka (Upstash)| --> | Python Consumer Script|           |
|  +-------------------------+     +----------------+     +-----------------------+           |
|                                                                  |                         |
|                                                                  v (Write to...)           |
|                                                           +--------------------+           |
...
|                                                                                            |
+--------------------------------------------------------------------------------------------+
(All code managed and versioned in a local Git repository and pushed to GitHub)